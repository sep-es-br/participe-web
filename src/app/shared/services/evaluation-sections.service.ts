...
import { IEvaluationSection, IEvaluationSectionCreate } from "../interface/IEvaluationSection";
...
export class EvaluationSectionsService {
  ...
  private serversMockList: Array<IOrganogramaData> = [
    {guid: 'propidByAuthDoRelacionamentoIS_EVALUATED_BY', name: "Artur Uhlig de Faria"},
  ...
  public getEvaluationSectionsList(): Promise<Array<IEvaluationSection>> {
    return this._http.get<Array<IEvaluationSection>>(this._url, { headers: this.headers }).toPromise();
  }

  public postEvaluationSection(body: IEvaluationSectionCreate): Promise<IEvaluationSection> {
    return this._http
      .post<IEvaluationSection>(this._url, body, { headers: this.headers })
      .toPromise();
  }

  public putEvaluationSection(id: number, body: IEvaluationSectionCreate): Promise<IEvaluationSection> {
    return this._http
      .put<IEvaluationSection>(`${this._url}/${id}`, body, { headers: this.headers })
      .toPromise();
  }
}
